...
--nfirst query displays ascending list according to brand id and also grouping in each brand id . Second query displays descending list price not grouping brand id .
